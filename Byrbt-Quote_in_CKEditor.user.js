...
const DEFAULT_STYLE = [
    {
        ...
        "name": "带框折叠样式",
        "style": "<fieldset style=\"font-family: Consolas;\"><details><summary><span style=\"color:#ffffff;background-color:#000000;\">&nbsp;{0}&nbsp;</span></summary><div>{1}<br>.</div></details></fieldset>",
        "checked": true
    }, {
       "name": "@NORMALX滚动条样式",
       "style": "<fieldset><legend><span style='color:#ffffff; background-color:#000000; font-family: Consolas'><strong>&nbsp;{0}&nbsp;</strong></span></legend><div class='van-dialog__message van-dialog__message--has-ti&lt;x&gt;tle' style=\"box-sizing: border-box; max-height: 50vh; padding: 0px 0px 0px; overflow-y: auto; white-space: unset; overflow-wrap: break-word; font-family: 'Consolas';\">{1}</div></fieldset>",
    }, {
        "name": "折叠样式",
        "style": "<details style=\"font-family: Consolas;\"><summary><span>&nbsp;{0}&nbsp;</span></summary><div>{1}<br>.</div></details>",
        "checked": false
    }, {
        "name": "类似其他PT站的代码格式",
...
CKEDITOR.on('instanceReady', function (evt) {
    ...
    code_btn.click(function () {
        ...
        $("#modal_update").click(function () {
            ...
            //console.log(insert_data_raw);
            CKEDITOR.instances.descr.insertHtml(insert_data_raw);
